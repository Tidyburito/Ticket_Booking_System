...
--
-- Table structure for table `abcd_history`
--

DROP TABLE IF EXISTS `abcd_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `abcd_history` (
...
--
-- Dumping data for table `abcd_history`
--

LOCK TABLES `abcd_history` WRITE;
/*!40000 ALTER TABLE `abcd_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `abcd_history` ENABLE KEYS */;
UNLOCK TABLES;
