...
--
-- Table structure for table `adil_history`
--

DROP TABLE IF EXISTS `adil_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `adil_history` (
...
--
-- Dumping data for table `adil_history`
--

LOCK TABLES `adil_history` WRITE;
/*!40000 ALTER TABLE `adil_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `adil_history` ENABLE KEYS */;
UNLOCK TABLES;
