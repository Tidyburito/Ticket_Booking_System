...
--
-- Table structure for table `chetan_cart`
--

DROP TABLE IF EXISTS `chetan_cart`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `chetan_cart` (
...
--
-- Dumping data for table `chetan_cart`
--

LOCK TABLES `chetan_cart` WRITE;
/*!40000 ALTER TABLE `chetan_cart` DISABLE KEYS */;
/*!40000 ALTER TABLE `chetan_cart` ENABLE KEYS */;
UNLOCK TABLES;
