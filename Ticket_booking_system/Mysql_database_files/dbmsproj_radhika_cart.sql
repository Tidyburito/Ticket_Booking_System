...
--
-- Table structure for table `radhika_cart`
--

DROP TABLE IF EXISTS `radhika_cart`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `radhika_cart` (
...
--
-- Dumping data for table `radhika_cart`
--

LOCK TABLES `radhika_cart` WRITE;
/*!40000 ALTER TABLE `radhika_cart` DISABLE KEYS */;
/*!40000 ALTER TABLE `radhika_cart` ENABLE KEYS */;
UNLOCK TABLES;
