...
CREATE TABLE `stadium` (
  ...
  `seat_lounge` varchar(30) DEFAULT NULL,
  `available` int DEFAULT NULL,
  `price` int DEFAULT NULL,
  KEY `event_id` (`event_id`),
  CONSTRAINT `stadium_ibfk_1` FOREIGN KEY (`event_id`) REFERENCES `booking` (`event_id`)
...
INSERT INTO `stadium` VALUES ('ST01','A',47,400),('ST01','B',60,500),('ST01','C',80,300),('ST01','D',50,400);
