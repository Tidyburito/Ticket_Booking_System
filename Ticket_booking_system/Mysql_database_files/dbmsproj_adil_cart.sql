...
--
-- Table structure for table `adil_cart`
--

DROP TABLE IF EXISTS `adil_cart`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `adil_cart` (
...
--
-- Dumping data for table `adil_cart`
--

LOCK TABLES `adil_cart` WRITE;
/*!40000 ALTER TABLE `adil_cart` DISABLE KEYS */;
/*!40000 ALTER TABLE `adil_cart` ENABLE KEYS */;
UNLOCK TABLES;
