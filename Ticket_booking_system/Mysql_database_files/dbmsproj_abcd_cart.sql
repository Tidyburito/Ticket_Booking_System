...
--
-- Table structure for table `abcd_cart`
--

DROP TABLE IF EXISTS `abcd_cart`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `abcd_cart` (
...
--
-- Dumping data for table `abcd_cart`
--

LOCK TABLES `abcd_cart` WRITE;
/*!40000 ALTER TABLE `abcd_cart` DISABLE KEYS */;
/*!40000 ALTER TABLE `abcd_cart` ENABLE KEYS */;
UNLOCK TABLES;
